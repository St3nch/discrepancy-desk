...
| HT-03 | Lifecycle legality and invalidation | legal/illegal transitions, manual-ready/publication gates | partial |
...
| HT-13 | Explicit unknown states | schema vocabulary exists; broader query semantics pending | partial |
...
| HT-17 | Interrupted migration recovery | guarded Alembic execution and retained marker on failure | partial |
...
| HT-20 | Detector/classifier non-authority | no detector can approve; deliberate detector-error fixtures pending | partial |
