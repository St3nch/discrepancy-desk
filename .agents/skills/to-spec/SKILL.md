---
name: to-spec
description: "Turn the current conversation into a non-authoritative draft spec for Project Steward review: no interview, just synthesis of what you've already discussed."
...
3. Write the spec using the template below and return it for Project Steward review. In Desk mode, do not publish it to an external tracker, do not apply triage labels, and do not promote it to authority.
